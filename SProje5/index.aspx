<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SProje5.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="m-4">
        <h2>Öne Çıkanlar</h2>
        <div class="row">
            <asp:Repeater ID="onerilenUrunler" runat="server">
                <ItemTemplate>
