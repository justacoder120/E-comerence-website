<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ayakkabıGuncelle.aspx.cs" Inherits="SProje5.ayakkabıGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card">
        ...
        <div class="mb-3">
            <asp:Image class="resim" ID="Resim" runat="server" />
        </div>
        <asp:Button class="btn btn-primary w-25" ID="btnGuncelle" runat="server" Text="Güncelle" OnClick="btnGuncelle_Click" />
    </div>
</asp:Content>
